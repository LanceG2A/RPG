...
public class Demo {
 ...
 public static void main(String[] args) {
  ...
  System.out.println("Choose your armor!  Enter the number of your choice: "
   ...
   if(character.armor > 0 && character.armor < 3) //This if statement ends the while loop if 
  ...
  character.blessing = keyboard.nextInt();
  

  
  
  if(character.blessing > 0 && character.blessing < 4)
  {
   p++;
  }
  else
  ...
  switch(character.blessing)   //Character's damage, defense, or health is increased 
